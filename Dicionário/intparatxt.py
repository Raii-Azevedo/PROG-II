# PROGRAMA PARA CONVERTER UM NÚMERO DECIMAL EM TXT
...
def converte_dec_txt(d, num):
    ...
    if len(lst) == 1:
        ...
        parte_dec_int = int(txt_depois_do_ponto[i:])
        parte_dec_txt = converte_2_txt(d, parte_dec_int)
